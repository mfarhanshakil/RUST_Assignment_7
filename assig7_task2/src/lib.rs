...
// THIS LIBRARY IS THE TASK # 2 OF ASSIGNMENT # 7
// THIS FILE IS LOCATED INSIDE SAME DIRECTORY OF "main.rs"
// MODULE IS CREATED INSIDE "lib.rs" WITH A SUB-MODULE INSIDE 
// FUNCTION ARE DEFINED INSIDE SU-BMODULE AND CALLED FROM "main.rs"
...
{   
    pub mod about                        // START OF SUB MODULE "about" INSIDE "piaic"
    {
        ...
        {                                          // VECTOR TO STORE PROGRAMS OFFERED
            let prog_det : Vec<&'static str> = vec![PiaicAbout::AIC.get_details() , 
            ...
            {
                println!("\t {}) {}" , lp_var + 1 , prog_det[lp_var as usize]); 
